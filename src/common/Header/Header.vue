    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse navbar-left header-left-menu">
        <ul class="nav navbar-nav header-left-ul">
          <li class="dropdown">
            <a href="javascript:;" class="dropdown-toggle header-menu-item-link header-realign" data-toggle="dropdown" id="header-current-country-flag-link"><span class="flag-img my"></span>Malaysia <b class="caret"></b></a>
            <ul class="dropdown-menu flag-child flag-realign">
              <li><a rel="sg" title="Find Jobs in Singapore, Apply for Singapore Jobs with JobStreet.com Singapore" class="" href="//www.jobstreet.com.sg" id="flag-country-sg-link"><span class="flag-img sg"></span>Singapore</a></li>
              <li><a rel="my" title="JobStreet.com Malaysia - Jobs in Malaysia, Selangor, Kuala Lumpur, Penang, Johor, Singapore, Asia. Jawatan Kosong" class="selected" href="//www.jobstreet.com.my" id="flag-country-my-link"><span class="flag-img my"></span>Malaysia</a></li>
              <li><a rel="ph" title="Jobs in Philippines, Job Search, Job Employment, Apply Job, Jobs in Manila, Work Abroad" class="" href="//www.jobstreet.com.ph" id="flag-country-ph-link"><span class="flag-img ph"></span>Philippines</a></li>
              <li><a rel="id" title="Lowongan kerja Indonesia &amp; lamaran kerja terbaru | Jobs in Indonesia - Jobstreet.com" class="" href="//www.jobstreet.co.id" id="flag-country-id-link"><span class="flag-img id"></span>Indonesia</a></li>
              <li><a rel="vn" title="Viec lam &amp; Tuyển dụng - Jobs in Vietnam at JobStreet.vn" class="" href="//www.jobstreet.vn" id="flag-country-vn-link"><span class="flag-img vn"></span>Vietnam</a></li>
            </ul>
          </li>
          <li class="visible-xs">
            <a href="https://www.jobstreet.com.my/employers/" title="For Employers Malaysia - Log in and post job ads" id="header-mobile-employer-link" class="mobile-employer">Employers</a>
          </li>
        </ul>
      </div>
...
<style>
  ...
  *,*:before,*:after {
  ...
  .alert h1,.alert h2,.alert h3,.alert
  h4 {
  ...
  .jslogo.my {
    background:url("../../assets/jobstreet-my.png") no-repeat
  }
  .jslogo.sg {
  ...
  .list-group-item.active .list-group-item-header,.list-group-item.active:hover .list-group-item-header,.list-group-item.active:focus .list-group-item-header {
    color:inherit
  }
  ...
  .btn [class^="icon-"],.btn [class*="icon-"],.btn [class^="fa-"],.btn [class*="fa-"] {
    top:1px
  }
  .x2 {
    font-size:2em
  ...
  .nav-tabs>.dropdown>a:hover .caret,.nav-tabs>.dropdown>a:active .caret,.nav-tabs>.dropdown>a:focus .caret,.nav-tabs>.dropdown.active
  .caret {
  ...
  .nav-pills>.dropdown.active .caret,.nav-pills>.dropdown.active>a:hover .caret,.nav-pills>.dropdown.active>a:focus
  .caret {
    border-top-color:#333;
    border-bottom-color:#333
  }
  .nav-pills>.dropdown>a:hover .caret,.nav-pills>.dropdown>a:active .caret,.nav-pills>.dropdown>a:focus
  .caret {
    border-top-color:#1c3f94;
    border-bottom-color:#1c3f94
  }
  ...
  .navbar-default .navbar-nav>.dropdown>a:hover .caret,.navbar-default .navbar-nav>.dropdown>a:focus
  .caret {
    border-top-color:#1c3f94;
    border-bottom-color:#1c3f94
  }
  ...
  .navbar-default .navbar-nav>.open>a .caret,.navbar-default .navbar-nav>.open>a:hover .caret,.navbar-default .navbar-nav>.open>a:focus
  .caret {
    border-top-color:#1c3f94;
    border-bottom-color:#1c3f94
  }
  @media(max-width:767px) {
    ...
    .navbar-default .navbar-nav>.dropdown>a:hover .caret,.navbar-default .navbar-nav>.dropdown>a:focus .caret,.navbar-default .navbar-nav>.open>a .caret,.navbar-default .navbar-nav>.open>a:hover .caret,.navbar-default .navbar-nav>.open>a:focus
    .caret {
      border-top-color:#fff;
  ...
  .navbar-inverse .navbar-nav>.dropdown>a:hover .caret,.navbar-inverse .navbar-nav>.dropdown>a:focus
  .caret {
    border-top-color:#fff;
    border-bottom-color:#fff
  }
  ...
  .navbar-inverse .navbar-nav>.open>a .caret,.navbar-inverse .navbar-nav>.open>a:hover .caret,.navbar-inverse .navbar-nav>.open>a:focus
  .caret {
    border-top-color:#fff;
    border-bottom-color:#fff
  }
  ...
  .navmenu-default,.navbar-default .navbar-offcanvas,.navmenu-inverse,.navbar-inverse .navbar-offcanvas {
    background-color:#333;
    border-color:#666;
    overflow-y:auto
  }
  ...
  .table caption+thead tr:first-child th,.table colgroup+thead tr:first-child th,.table thead:first-child tr:first-child th,.table caption+thead tr:first-child td,.table colgroup+thead tr:first-child td,.table thead:first-child tr:first-child
  td {
    border-top:0
  }
  .table tbody+tbody {
  ...
  .table tbody>tr>td,.table-hover tbody>tr>td,.table-bordered tbody>tr>td,.table-striped tbody>tr>td {
    padding:6px
    6px 24px;
    border-top:1px solid #ccc
  }
  ...
  textarea.form-control,textarea.input-sm,textarea.input-lg {
    height:auto
  }
  .input-sm {
    height:30px;
  ...
  .logo.sg {
    /*background:url("../img/logo/v3/jobstreet-sg.png") no-repeat*/
  }
  .logo.ph {
    /*background:url("../img/logo/v3/jobstreet-ph.png") no-repeat*/
  }
  .logo.id {
    /*background:url("//dna.jsstatic.com/img/jobstreet-id.png") no-repeat*/
  }
  .logo.vn {
    /*background:url("../img/logo/v3/jobstreet-vn.png") no-repeat*/
  }
  ...
  .carousel-caption-box .btn-primary,.carousel-caption-box .btn-default,.mobile-caption .btn-primary,.mobile-caption .btn-default {
    font-weight:bold;
    text-shadow:none
  }
  .btn-login {
  ...
  .header-right-menu .caret, .header-left-menu
  .caret {
    border-bottom-color:#1c3f94 !important;
    border-top-color:#1c3f94 !important
  }
  .mobile-login {
    margin-top:5px
  }
  ...
  .language-id .mobile-caption-sub
  p {
    width:220px
  }
  .language-vn .mobile-caption-sub
  p {
    width:270px
  }
  ...
  .quality-job,.quality-emp,.quality-trust {
    padding:6px
    0
  }
  ...
  #name-form.has-error #first_name, .has-error
  #last_name {
    border-color:#ccc
  }
  .has-error>#first_name,.has-error>#last_name {
  ...
  @media only screen and (max-width : 385px) {
    .language-vn #lbl_fb_login, .language-vn
    #lbl_fb_signup {
  ...
  @media only screen and (min-width: 768px) {
    ...
    #name-form.has-error #firstname-form, .has-error #lastname-form {
      margin-bottom:0
    }
    .equal {
      display:-webkit-box;
  ...
  @media only screen and (max-width : 767px) {
    .logo.my,.logo.sg,.logo.ph,.logo.vn,.logo.id {
      background:url("../../assets/jobstreet-mobile-logo.png") 0px 0px no-repeat;
    ...
    .mobile-caption {
      /*background:#1C3F94 url(../img/mobile_bg.jpg) no-repeat center top*/
    }
    .footer-item-panel {
  ...
  @media only screen and (max-width : 1023px) {
    .language-vn .quality-job, .language-vn .quality-emp, .language-vn .quality-trust, .language-id .quality-job, .language-id .quality-emp, .language-id .quality-trust {
      display:block
    }
    .language-vn  .bullet, .language-id
    .bullet {
      display:none
    }
  }
  ...
  #smartbanner.android .sb-button:active span,#smartbanner.android .sb-button:hover
  span {
    background:#2AC7E1
  }
  #smartbanner.android {
